...
public class TalonFXTankDrivetrain extends DashboardedSubsystem implements SmartMotorControllerTankDrivetrain {
    ...
    public TalonFXTankDrivetrain(String namespaceName, TalonFX leftMaster,
        ...
        leftSlaves.forEach(talonFX -> talonFX.setControl(new Follower(leftMaster.getDeviceID(),
                MotorAlignmentValue.Aligned)));
        rightSlaves.forEach(talonFX -> talonFX.setControl(new Follower(rightMaster.getDeviceID(),
                MotorAlignmentValue.Aligned)));
    ...
    public void pidSet(UnifiedControlMode controlMode, double leftSetpoint, double rightSetpoint,
        ...
        leftSlaves.forEach(s -> s.setControl(new Follower(leftMaster.getDeviceID(), MotorAlignmentValue.Aligned)));
        rightSlaves.forEach(s -> s.setControl(new Follower(rightMaster.getDeviceID(), MotorAlignmentValue.Aligned)));
    }
