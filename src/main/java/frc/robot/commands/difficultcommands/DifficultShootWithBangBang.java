...
public class DifficultShootWithBangBang extends MoveGenericSubsystem {
    ...
    public DifficultShootWithBangBang(Shooter shooter, Supplier<Double> speed, Supplier<Double> tolerance) {
        super(shooter, speed);
    ...
    public DifficultShootWithBangBang(Shooter shooter, Supplier<Double> speed) {
