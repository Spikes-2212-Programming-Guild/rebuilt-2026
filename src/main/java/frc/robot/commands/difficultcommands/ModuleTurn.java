...
public class ModuleTurn extends TurnModules {
    public ModuleTurn(SwerveDrivetrain drivetrain, Rotation2d frontLeftDesiredAngle, Rotation2d frontRightDesiredAngle,
                      Rotation2d backLeftDesiredAngle, Rotation2d backRightDesiredAngle) {
