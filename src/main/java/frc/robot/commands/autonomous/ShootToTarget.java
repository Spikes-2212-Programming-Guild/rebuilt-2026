...
public class ShootToTarget extends SequentialCommandGroup {
    ...
    public ShootToTarget(Drivetrain drivetrain, Shooter shooter, Kicker kicker,
                         SpinningMagazine spinningMagazine, VisionService visionService, Roller collection) {
        addCommands(
