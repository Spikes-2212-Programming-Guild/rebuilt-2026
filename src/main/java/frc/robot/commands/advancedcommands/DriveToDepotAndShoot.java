...
/*
    init_pos: 3.75m, 6m  # in-front of depot
    init_angle: intake facing other alliance
 */
public class DriveToDepotAndShoot extends SequentialCommandGroup {

    public DriveToDepotAndShoot(Drivetrain drivetrain, Shooter shooter,
        ...
        addCommands(
                ...
                new SwerveRotateWithPID(drivetrain, () -> 180.0, false), // rotate to face depot

                new ParallelDeadlineGroup( // keep collecting until drove the entire way
                        new Collect(collection, collectionMovement),
                        new DriveDistanceWithPID(drivetrain, -2.25, DriveDirection.X, false)
                ),

                new DriveDistanceWithPID(drivetrain, 2, DriveDirection.X, false), // drive to shooting position
                new SwerveRotateWithPID(drivetrain, () -> null, false), // rotate to shoot
                new AccelerateAndShoot(shooter, () -> null, spinningMagazine, kicker)
                        .withTimeout(-1) // shoot until all balls are shot
